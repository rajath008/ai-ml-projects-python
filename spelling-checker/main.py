...
def main_window():
    ...
    label1=Label(win,text="Word to check",font=("Arial",25,"bold"),bg="Blue",fg="white")
    label1.place(x=100,y=20,height=50,width=300)

    enter1=Entry(win,font=("Arial",20))
    enter1.place(x=50,y=80,height=50,width=400)
    
    
    label2=Label(win,text="Correct word",font=("Arial",25,"bold"),bg="Blue",fg="white")
    label2.place(x=100,y=140,height=50,width=300)

    enter2=Entry(win,font=("Arial",20))
    enter2.place(x=50,y=200,height=50,width=400)

    button=Button(win,text="Done",font=("Arial",25,"bold"),bg="yellow",command=correct_spelling)
